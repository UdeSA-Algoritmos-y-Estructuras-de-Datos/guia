...
\begin{Exercise}
	...
	\Question \mintinline{c}|int stack_sorted_ascending(pila\_t* pila);| que verifica si los elementos de la pila están ordenados en orden creciente
\end{Exercise}
...
\chapter{Heaps}
\begin{Exercise}
	Cuál es la complejidad de \texttt{heapify}
